...
import { IconSunglasses, IconDeviceWatch } from '@tabler/icons-react'
import { useCartStore } from '@/store/cartStore'
import Toast from '@/app/components/Toast'
import SkeletonCard from '@/app/components/SkeletonCard'

const SUBCATEGORIAS = ['Todo', 'Gorras', 'Carteras', 'Bandoleras', 'Relojes', 'Gafas']
...
const productos = [
  ...
  { id: '5', nombre: 'Gafas de sol', marca: 'Ray-Ban', precio: 55, categoria: 'Gafas', genero: 'Unisex', tallas: ['Única'], badge: null, icon: <IconSunglasses size={36} stroke={1.5} color="#bbb" /> },
  { id: '6', nombre: 'Reloj deportivo', marca: 'Casio', precio: 38, categoria: 'Relojes', genero: 'Masculino', tallas: ['Única'], badge: 'Destacado' as string | null, icon: <IconDeviceWatch size={36} stroke={1.5} color="#bbb" /> },
]

export default function CatalogoComplementos() {
  ...
  return (
    <div style={{ background: '#f5f5f5', minHeight: '100vh' }}>
      ...
      <div style={{ background: '#fff', borderBottom: '1px solid #e5e5e5', padding: '10px 24px', display: 'flex', alignItems: 'center', gap: '8px' }}>
        ...
        <span style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '12px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', color: '#111' }}>Complementos</span>
      </div>
