...
import { IconHeadphones, IconDeviceWatch } from '@tabler/icons-react'
...
const productos = [
  { id: '3', nombre: 'Auriculares BT', marca: 'JBL', precio: 45, categoria: 'Auriculares', genero: 'Unisex', tallas: ['Única'], badge: null, icon: <IconHeadphones size={36} stroke={1.5} color="#bbb" /> },
